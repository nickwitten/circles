...
if 'DJANGO_SECRET_KEY' in os.environ:
    ...
    print("Generating Django secret key. Please set environment variable 'DJANGO_SECRET_KEY' in production.")
...
if 'AWS_ACCESS_KEY_ID' in os.environ:
    ...
    MEDIA_URL = '/media/'
    print(f"Setting media storage to local directory: {MEDIA_ROOT}")
    print("Please make sure this is desired in production.")
