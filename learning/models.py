...
class AbstractProgramming(models.Model):
    ...
    facilitator_profiles = models.ManyToManyField(members_models.Profile, related_name='facilitate_programming')
    ...
    def to_dict(self):
        ...
        model_info['facilitator_profiles'] = [[str(profile), profile.pk] for profile in model_info['facilitator_profiles']]
        return model_info
...
class Module(AbstractProgramming):
    ...
    facilitator_profiles = models.ManyToManyField(members_models.Profile, related_name='facilitate_modules')
